...
def female_part():
    return html.Div(
        [
            dcc.Graph(id="female-part", figure=female_participation()),
        ]
    )
...
def xcs_men():
    return html.Div([dcc.Graph(id="xcs-men-test", figure=men_team_xcs_plot())])


def xcs_women():
    return html.Div([dcc.Graph(id="xcs-women", figure=women_team_xcs_plot())])
...
def xcs_germany_plot():
    return html.Div([dcc.Graph(id="xcs-germany-plot", figure=germany_xcs())])
...
def div3():
    return dbc.Card(
        ...
        """
            ...
            dbc.Row([dbc.Col(html.Div(xcs_germany_plot()), md=10)]),
        ]
    )
